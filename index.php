...
<header id="home" class="top-hero p-b-3 m-b-3">
  <div class="container col-lg-8 top-hero-text">
    <div class="container animated fadeInUp">
      <h1 class="display-3">Ownii</h1>
      <p class="lead m-t-1">
        The World's First Revolutionary Utility, Asset-Based, Smart
        Blockchain, LiFi Technology. Global New Infrastructure, Digital Token.
      </p>
  ...
  <!-- <div class="col-lg-3  "> -->
  <div class="container rotatecoin">
    <div class="row justify-content-center">
      <div class="col-lg-3">
        <div id="f1_container">
          <div id="f1_card">
            <div class="front face">
              <img src="img/coin-front1.png">
            </div>
            <div class="back face">
              <img src="img/coin-back1.png">
            </div>
          </div> <!-- fl_card -->
        </div> <!-- f1-container -->
      </div> <!-- col-lg-2 -->
...
<div class="container-fluid two-column-1">
  <div class="row">
    <div class="col-md-6 about-col1">
      ...
      <p> It is safer, healthier and with far more advantages than the alternative of small cell towers electromagnetically transmitting within short distances of each other in our communities, </p>
      <a href="about.php" class="btn btn-primary">Learn More</a>
    </div>
    <div class="col-lg-6 about-col2">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card featured-icon-card">
        <div class="featured-icon-container">
          <i class="fa fa-road fa-bs-responsive"></i>
        </div>
        <div class="featured-icon-textbox">
        <a href="roadmap.php">
          <h3>Roadmap</h3>
          <p>Check out the future</p>
        </a>
        </div>
      </div>
    ...
    <div class="col-md-4">
      ...
      <div class="card featured-icon-card">
        ...
        <div class="featured-icon-container">
          <i class="fa fa-question fa-bs-responsive"></i>
        </div>
        <div class="featured-icon-textbox">
          <a href="#">
            <h3>FAQ</h3>
...
<div class="countdowntimer">
  <div class="example">
    <p>Private Token Sale Starts in</p>

    <div id="flipdown" class="flipdown"></div>
    <p class="pt-3">$25,256,432 contributions received</p>
    <div class="progress animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="1.3s" style="animation-delay: 1.3s; opacity: 1;">
                            <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="46" aria-valuemin="0" aria-valuemax="100" style="width:20%"> % </div>
                                <span class="progress_label" style="left: 30%"> <strong> $125000 </strong></span>
                                <span class="progress_label" style="left: 75%"> <strong> $50 Billion </strong></span>
                                <span class="progress_min_val">Softcap</span>
                                <span class="progress_max_val">Hardcap</span>
                            </div>
  </div>
</div>
...
<div class="wrapper">
  <div class="wrapper-inner">
    <div class="counter col_fourth">
      ...
      <h2 class="timer count-title count-number" data-to="25256432" data-speed="1500">%</h2>
       <p class="count-text ">Contributions Received</p>
    </div>

    <div class="counter col_fourth">
      <i class="fa fa-link fa-3x"></i>
      <h2 class="timer count-title count-number" data-to="54" data-speed="1500"></h2>
      <p class="count-text ">% Platform Integration</p>
    </div>
